...
def downgrade() -> None:
    ...
    with op.batch_alter_table("club_settings", schema=None) as batch_op:
        batch_op.add_column(
            sa.Column("default_elo", sa.Integer(), nullable=False, server_default="1200")
        )
        batch_op.add_column(
            sa.Column("k_factor", sa.Float(), nullable=False, server_default="32.0")
        )
        batch_op.add_column(
            sa.Column("inactivity_months", sa.Integer(), nullable=False, server_default="3")
        )
